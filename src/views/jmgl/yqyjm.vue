            ...
            <wn-form  :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="80px" class="demo-ruleForm wnform">
              <wn-row >
                ...
                <wn-col  :xs="24"  :sm="24" :md="8" :lg="4" style="text-align: right;margin-bottom: 10px;">
                  ...
                  <wn-button type="warning" @click="handleAdd">迁移团队</wn-button>
                </wn-col>
              </wn-row>
              <wn-row >
                <!--第二行-->
                ...
                <wn-col  :xs="24"  :sm="24" :md="8" :lg="4" style="text-align: right;margin-bottom: 10px;">
                  ...
                  <wn-button type="warning" @click="handleAdd">全部迁移</wn-button>
                </wn-col>
              </wn-row>
            </wn-form>
          </div>
        ...
        <div class="box">
          ...
          <div class="box-content clearfix" style="padding: 0 10px;">
            ...
            <wn-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" :row-class-name="tableRowClassName" style="width: 100%;">
              ...
              <wn-table-column prop="telphone" label="紧急电话" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="servicedate" label="签约日期"  width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="qyrq" label="协议止日" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="fwr" label="签约人" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="fwcs" label="签约总次数" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column  label="操作" min-width="180" header-align="center" align="center">
                <template slot-scope="scope">
                  ...
                  <i class="iconfont icon-zj" @click="handleCheck(scope.$index, scope.row)" title="转介"></i>
                </template>
              </wn-table-column>
            </wn-table>
            <!--分页功能-->
