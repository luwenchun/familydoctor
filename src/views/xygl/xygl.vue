        ...
        <div class="box">
          ...
          <div class="box-content clearfix" style="padding: 0 10px;">
            ...
            <wn-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" :row-class-name="tableRowClassName" style="width: 100%;">
              ...
              <wn-table-column prop="xybh" label="协议编号" width="100"  header-align="center" align="center" >
              </wn-table-column>
              ...
              <wn-table-column prop="qyrq" label="签约日期" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="servicedate" label="协议止日" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="qytd" label="签约团队" width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="fwr" label="签约人" min-width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="price" label="实付金额（元）" min-width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="price" label="补助金额（元）" min-width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="px" label="进度" min-width="100" header-align="center" align="center">
              </wn-table-column>
              <wn-table-column prop="xyglzt" label="状态"  min-width="100" header-align="center" align="center">
              </wn-table-column>
              ...
              <wn-table-column  label="操作" width="180" header-align="center" align="center">
                <template slot-scope="scope">
                  ...
                  <i class="iconfont icon-xy" @click="handleStop(scope.$index, scope.row)" title="续约"></i>
                  <i class="iconfont icon-jy" @click="handleCheck(scope.$index, scope.row)" title="解约"></i>
                  <i class="iconfont icon-ws" @click="handleCheck(scope.$index, scope.row)" title="文书"></i>
                </template>
              </wn-table-column>
            </wn-table>
            <!--分页功能-->
